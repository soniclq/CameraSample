...
package com.example.camerasample.gl;
...
public class GlUtil {
    ...
    public static int createProgram(Context context, int vertexid, int fragmentid) {
        String vertexSource = readTextFromRawResource(context, vertexid);
        String fragmentSource = readTextFromRawResource(context, fragmentid);
...
//            throw new RuntimeException(msg);
    ...
    public static String readTextFromRawResource(Context context, int resourceId) {
